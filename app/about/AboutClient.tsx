...
import { MapPin, Calendar, X, Download, ExternalLink, ScrollText } from "lucide-react";
          ...
          >
            ...
            <div className="p-2 border-t border-border bg-card/50 flex-shrink-0 text-center">
              <p className="text-xs text-muted-foreground">
                Place file at: <code className="text-primary text-xs">public{pdfPath}</code>
              </p>
            </div>
          </motion.div>
        </>
        ...
        >
          <div className="glass rounded-2xl p-8 border border-border card-shine">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              I&apos;m a passionate Software Engineer based in Sri Lanka, specializing
              in modern web development. With over 3 years of hands-on experience,
              I build scalable, performant and visually compelling digital products.
              My expertise spans the full stack — from crafting pixel-perfect UIs
              with React and Next.js, to architecting robust backend systems with
              Node.js and MySQL. I care deeply about code quality, developer
              experience and building products that make a real difference to users.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              When I&apos;m not coding, I enjoy learning about new technologies,
              contributing to open source, and sharing my knowledge through blog posts.
            </p>
          </div>
          <div className="glass rounded-2xl p-8 border border-border card-shine">
            <h3 className="text-xl font-bold mb-4 gradient-text" style={{ fontFamily: "Syne, sans-serif" }}>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className={`ml-16 md:ml-0 ${
                  index % 2 === 0 ? "md:col-start-1 md:pr-16" : "md:col-start-2 md:pl-16"
                }`}>
                  <motion.div
                    whileHover={{ y: -4 }}
                  ...
                  >
                    <div className="flex items-start justify-between mb-4 gap-3">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-bold text-foreground text-lg leading-tight" style={{ fontFamily: "Syne, sans-serif" }}>
                            {exp.role}
                          </h3>
                          <p className="text-primary font-semibold text-sm">{exp.company}</p>
                        </div>
                      </div>
                      <span className={`px-2 py-1 rounded-md text-xs font-semibold border flex-shrink-0 ${
